...
export default function App() {
  ...
  const [showTaskForm, setShowTaskForm] = useState(false); // Added for modal
            ...
            <div className="flex justify-between items-center mb-8">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={`p-3 rounded-lg ${showFilters ? 'bg-gray-200' : 'bg-white'} hover:bg-gray-200`}
                >
              ...
              <div className="flex gap-4 border-b border-gray-200">
                {['all', 'active', 'completed', 'due-soon'].map((tab) => (
                  <button
                    ...
                    className={`pb-2 px-4 text-lg font-medium ${activeTab === tab ? 'border-b-2 border-indigo-600 text-indigo-600' : 'text-gray-600 hover:text-indigo-600'}`}
                  >
                    {tab === 'all' && 'All'}
                    {tab === 'active' && 'Active'}
